        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
            ...
            <div className="relative bg-black aspect-video">
              ...
              {/* Bottom overlay buttons (only when stream active) */}
              {remoteStream && (
                <div className="absolute bottom-2 right-2 flex items-center gap-2">
                  {/* Flip camera */}
                  <button
                    onClick={() => sendAction('flip_camera')}
                    title="Girar camara"
                    className="w-9 h-9 rounded-full bg-slate-900/80 backdrop-blur-sm border border-slate-700 flex items-center justify-center hover:bg-slate-800 transition-colors"
                  >
